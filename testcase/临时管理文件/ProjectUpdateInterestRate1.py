...
api='api/Project/{0}/InterestRate1'
sheet_name = "ProjectUpdateInterestRate1"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateInterestRate1(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateInterestRate1(self,data):
        interestrate1 = int(data["interestrate1"])
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['interestrate1'],interestrate1,case_describe + ",接口：{0}".format(api))
        else:
