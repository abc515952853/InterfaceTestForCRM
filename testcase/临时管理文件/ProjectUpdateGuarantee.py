...
api='api/Project/{0}/Guarantee'
sheet_name = "ProjectUpdateGuarantee"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateGuarantee(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateGuarantee(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['guarantee'],guarantee,case_describe + ",接口：{0}".format(api))
        else:
