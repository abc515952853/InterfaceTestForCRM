...
api='api/Project/{0}/Estimate'
sheet_name = "ProjectUpdateEstimate"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateEstimate(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateEstimate(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['estimate'],estimate,case_describe + ",接口：{0}".format(api))
        else:
