...
api='api/Project/{0}/Commitment'
sheet_name = "ProjectUpdateCommitment"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateCommitment(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateCommitment(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['commitment'],commitment,case_describe + ",接口：{0}".format(api))
        else:
