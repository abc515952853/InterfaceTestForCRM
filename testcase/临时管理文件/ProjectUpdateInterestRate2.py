...
api='api/Project/{0}/InterestRate2'
sheet_name = "ProjectUpdateInterestRate2"
...
class ProjectUpdateInterestRate2(unittest.TestCase): 
    ...
    def test_ProjectUpdateInterestRate2(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['interestrate2'],interestrate2,case_describe + ",接口：{0}".format(api))
        else:
