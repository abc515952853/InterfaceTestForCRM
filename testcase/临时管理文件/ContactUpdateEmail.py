...
api='api/Contact/{0}/Email'
sheet_name = "ContactUpdateEmail"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ContactUpdateEmail(unittest.TestCase): 
    ...
    def test_ContactUpdateEmail(self,data):
        ...
        if r.status_code == expected_code:
            ...
            self.assertEqual(contactdetails['email'],email,case_describe + ",接口：{0}".format(api))
        else:
