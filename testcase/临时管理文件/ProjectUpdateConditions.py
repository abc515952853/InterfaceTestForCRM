...
api='api/Project/{0}/Conditions'
sheet_name = "ProjectUpdateConditions"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateConditions(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateConditions(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['conditions'],conditions,case_describe + ",接口：{0}".format(api))
        else:
