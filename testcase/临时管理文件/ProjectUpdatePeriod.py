...
api='api/Project/{0}/Period'
sheet_name = "ProjectUpdatePeriod"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdatePeriod(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdatePeriod(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['period'],period,case_describe + ",接口：{0}".format(api))
        else:
