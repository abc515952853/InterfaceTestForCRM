...
api='api/Project/{0}/SellerName'
sheet_name = "ProjectUpdateSellerName"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateSellerName(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateSellerName(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['sellername'],sellername,case_describe + ",接口：{0}".format(api))
        else:
