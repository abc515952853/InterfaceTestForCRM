...
api='api/Project/{0}/BuyerName'
sheet_name = "ProjectUpdateBuyerName"

excel = ReadExcl.Xlrd()

@ddt.ddt
class ProjectUpdateBuyerName(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_ProjectUpdateBuyerName(self,data):
        ...
        if r.status_code==expected_code:
            ...
            self.assertEqual(projectdetails['buyername'],buyername,case_describe + ",接口：{0}".format(api))
        else:
