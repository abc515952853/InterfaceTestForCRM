...
api='api/Customer/{0}/synopsis'
sheet_name = "CustomerUpdateSynopsis"

excel = ReadExcl.Xlrd()

@ddt.ddt
class CustomerUpdateSynopsis(unittest.TestCase): 
    @ddt.data(*excel.get_xls_next(sheet_name))
    def test_CustomerUpdateSynopsis(self,data):
        ...
        if r.status_code==200:
            ...
            self.assertEqual(customerdetails['synopsis'],synopsis,case_describe + ",接口：{0}".format(api))
        else:
